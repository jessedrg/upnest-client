...
type AuroraVariant = 'dusk' | 'ember' | 'dawn';

export function Aurora({ variant = 'dusk' }: { variant?: AuroraVariant }) {
  const palettes: Record<AuroraVariant, { a:string; b:string; c:string; sun:string; mark:string }> = {
